...
func defaultKeyboard() -> Keyboard {
    ...
    let switchInput = Key(.SwitchInput)
    switchInput.uppercaseKeyCap = "ABC"
    switchInput.uppercaseOutput = "ABC"
    switchInput.lowercaseKeyCap = "ABC"
    defaultKeyboard.addKey(switchInput, row: 3, page: 0)
